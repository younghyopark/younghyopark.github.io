...
- **Distance based Vector Reward** 
    ...
    Of course, there might be **many more possible vector type reward functions**, which we will go through in the later part of the research, we first have to check whether my naive DDPG + multiRL implementation indeed does a decent job of training the model. Doing so, we will use the vector reward defined above as a baseline experiment. 

### Reach Task

- DDPG + HER (Sparse Reward)
  
  <center><iframe src="https://player.vimeo.com/video/551607232" width="522" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></center>
  
- DDPG + HER (Dense Reward)

<center><iframe src="https://player.vimeo.com/video/552231980" width="526" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></center>

- DDPG + HER + MultiRL

<center><iframe src="https://player.vimeo.com/video/551607782" width="522" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></center>

- Learning Curve

  <center><img src="https://live.staticflickr.com/65535/51188546151_e6da9955fe_o.png" alt="image-20210519121053637" style="zoom:50%;" /></center>
...
- DDPG + HER (Sparse reward)
  ...
  <center><iframe src="https://player.vimeo.com/video/551589477" width="522" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></center>
  
- DDPG + HER (Dense reward)

  <center></center><iframe src="https://player.vimeo.com/video/552233237" width="522" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></center>

- DDPG + HER + MultiRL

  <center><iframe src="https://player.vimeo.com/video/551589485" width="522" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></center>

- **Learning Curve Comparison**

<center><img src="https://live.staticflickr.com/65535/51187835122_321117581e_o.png" alt="image-20210519120437611" style="zoom:50%;" /></center>

For Push operation, although the baseline DDPG+HER method trains the model pretty well, but we can see that the usage of multiple reward functions makes the robot to **precisely align the object with the goal**, compared to the baseline training method.  
{:.info}
...
- **DDPG + HER (Sparse reward)**
  ...
  Trained the network for 50 epochs, 50 samples collected per epoch, updated the network 40 times per epoch.


<center><iframe src="https://player.vimeo.com/video/551589466" width="522" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></center>
...
<center><iframe src="https://player.vimeo.com/video/551589506" width="522" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></center>

Unfortuantely, for Pick And Place operation, multi-reward RL doesn't seem to be that efficient. It seems like, since the reward still exists even when the episode were not able to succeed to achieve its goal, the RL training algorithm seems to be stalling during its training phase at sub-optimal point. **Note that, in MultiRL phase,** the robot doesn't try to lift-up the object when the goal is in the air: this may be due to the fact that the reward is still (sufficiently) maximized only with the action that centers the only the x-y dimension between the object and goal position.
...
<center><iframe src="https://player.vimeo.com/video/551589491" width="522" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></center>

Using the same reward function we used for Pick And Place operation, with longer training epochs (200), baseline DDPG + HER doesn't seem to work well: the model frequently makes some non-sense mistake, pushing down the puck and making it to fall off the table. 

- **DDPG + HER + MultiRL**

<center><iframe src="https://player.vimeo.com/video/551589500" width="522" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></center>

Although success rate is similar (or slightly low) compared to the baseline DDPG + HER experiment, above demo video using multiple reward functions shows no non-sense actions: it is only suffering from low accuracy. 
...
- First of all, we can see that vector-type reward (multiple rewards) based on goal / achieved position basically seems to work fine in most cases. 
- Recall, that I altered the original DDPG algorithm to
  ...
  2. defined the loss function 
- However, for some tasks, especially the **Pick And Place** task, usage of multiple rewards ruined the model's performance compared to the baseline training method. 
- However, 

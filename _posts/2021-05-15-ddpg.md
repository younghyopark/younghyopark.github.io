...
which actually was the very motivation of this research form the beginning: if **shaping a single reward function is that difficult**, why don't we just **stack a bunch of possible simple rewards** and feed them to the agent all at the same time and enhance the training?
